...
def build_vocab(vids):
    '''
    given video ids 
    gathers the captions and build vocabulary
    output:vocabulary
    '''
    count_thr = 1
...
def main(opt):
    '''
    get options,vocab from main and call test
    '''
    ...
    wtoi['<sos>'] = 1
    itow[1] = '<sos>'
    test(opt,EncoderRNN,DecoderCNN,Convcap,itow,wtoi,modelfn='/home/sanjay/Documents/Video_convcap/checkpoint/model3162825.pth')        
